      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                      <!--TNER SELECIONADA LA PRIMERA OPCIONclass="nav-link active"-->
                <a href="chartjs.php" class="nav-link" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Estadisticos Agentes 411</p>
                </a>
              </li>
              <!--<li class="nav-item">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Estadisticos Agentes 411</h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-md-10">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Llamadas / Itop Mensual</h3>
            ...
            <!-- /.FIIIIIIIIIIIIIIIIINNNNNNN POSICION 4 -->

            <!-- STACKED BAR CHART -->
            <!--
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">PRUEBA 2</h3>
...
SELECT 
CASE
     WHEN dstchannel LIKE '%866800411%' THEN 'Servicios TI'
     WHEN dstchannel LIKE '%8-668-00-471%' THEN 'Oscar'
     WHEN dstchannel LIKE '%8-668-00-472%' THEN 'Lara'
     WHEN dstchannel LIKE '%8-668-00-473%' THEN 'Antonio'
     WHEN dstchannel LIKE '%8-668-00-474%' THEN 'Orson'
     WHEN dstchannel LIKE '%8-668-00-475%' THEN 'Jorge'
     WHEN dstchannel LIKE '%8-668-00-476%' THEN 'Miguel'
     WHEN dstchannel LIKE '%8-668-00-477%' THEN 'Luna'
     WHEN dstchannel LIKE '%8-668-00-478%' THEN 'Cain'
     WHEN dstchannel LIKE '%8-668-00-479%' THEN 'Guillermo'
     WHEN dstchannel LIKE '%8-668-00-480%' THEN 'Raul'     
     WHEN dstchannel LIKE '%8-668-00-481%' THEN 'Emanuel'
     WHEN dstchannel LIKE '%8-668-00-482%' THEN 'Abner'     
     WHEN dstchannel LIKE '%8-668-00-483%' THEN 'Horacio'  
     WHEN dstchannel LIKE '%8-668-00-484%' THEN 'Blas'  
     WHEN dstchannel LIKE '%avayah%' THEN 'Avaya'
     WHEN dstchannel LIKE '%ASTERISK%' THEN 'ASTERISK'
  END Atendio, COUNT(calldate) NumLlamadas FROM cdr
 
WHERE 
calldate BETWEEN CONCAT(YEAR(SYSDATE()),'-0',MONTH(SYSDATE()),'-01 00:00:00') AND CONCAT(last_Day(SYSDATE()),' 23:59:00')
/*calldate BETWEEN '2021-06-01 00:00:00' AND '2021-06-30 23:59:59'*/
...
WHEN  agent_id = '2' THEN 'P.GRAJEDA'
  ...
  AND YEAR(start_date) = YEAR(CURRENT_DATE()) AND team_id IN ('4')

  /*MONTH(start_date) = '06'
  AND YEAR(start_date) = '2021' AND team_id IN ('4')*/
 ...
 ?>
    ...
    var areaChartData = {
      labels  : [
       <?php 
      $num=1;
      //CICLO PARA RECORRER TABLA CON DATOS DE ITOP 
